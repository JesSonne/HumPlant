...
## Visualising community structure of interacting hummingbirds and plants
...
Below I compile additional ecological models suggested by you. The first is a suggestion inspired by one of our discussions. I also include some used in previous papers
```{r}
